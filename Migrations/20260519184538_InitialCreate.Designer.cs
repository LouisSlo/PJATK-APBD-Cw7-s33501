...
namespace Czwiczenie7.Migrations
{
    ...
    [Migration("20260519184538_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Czwiczenie7.Modele.Component", b =>
                {
            ...
            modelBuilder.Entity("Czwiczenie7.Modele.ComponentManufacturer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Czwiczenie7.Modele.ComponentType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Czwiczenie7.Modele.PC", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Czwiczenie7.Modele.PCComponent", b =>
                {
                    b.Property<int>("PCId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Czwiczenie7.Modele.Component", b =>
                {
                    b.HasOne("Czwiczenie7.Modele.ComponentManufacturer", "Manufacturer")
                        .WithMany("Components")
                        .HasForeignKey("ComponentManufacturerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Czwiczenie7.Modele.ComponentType", "Type")
                        .WithMany("Components")
            ...
            modelBuilder.Entity("Czwiczenie7.Modele.PCComponent", b =>
                {
                    b.HasOne("Czwiczenie7.Modele.Component", "Component")
                        .WithMany("PCComponents")
                        .HasForeignKey("ComponentCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Czwiczenie7.Modele.PC", "PC")
                        .WithMany("PCComponents")
                        .HasForeignKey("PCId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
